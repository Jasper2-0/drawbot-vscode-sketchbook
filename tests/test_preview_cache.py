...
from src.core.preview_cache import PreviewCache, CacheEntry
...
class TestPreviewCache:
    ...
    def test_disk_space_limit_enforcement(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert total_size <= 0.01  # Should be close to or under limit (with some tolerance)
    ...
    def test_concurrent_access_safety(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for worker_id in range(3):
                thread = threading.Thread(target=store_preview_worker, args=(worker_id,))
    ...
    def test_cache_url_generation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert f"v={result.version}" in result.preview_url  # Version in query string