...
from src.server.live_preview_manager import ConnectionInfo, LivePreviewManager
...
class TestLivePreviewManager:
    ...
    async def test_broadcast_message_serialization(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            messages = [
                ...
                {"type": "execution_started", "sketch": sketch_name},
            ]
    ...
    async def test_concurrent_connections(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            connect_tasks = [
                manager.connect_client(sketch_name, ws) for ws in websockets
            ]
            ...
            disconnect_tasks = [
                manager.disconnect_client(sketch_name, ws) for ws in websockets
            ]
