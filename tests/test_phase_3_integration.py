...
''')
            ...
            # Test broadcasting
            await manager.broadcast_to_sketch("manager_test", {
                "type": "test_message",
...
''')
            ...
            ws1_messages = [json.loads(call[0][0]) for call in mock_ws1.send.call_args_list]
            ws2_messages = [json.loads(call[0][0]) for call in mock_ws2.send.call_args_list]
...
''')
            ...
            # Find error message
            error_messages = [msg for msg in sent_messages if msg["type"] == "execution_error"]
