...
class SketchRunner:
    ...
    def run_sketch(self, sketch_path: Path, output_dir: Optional[Path] = None) -> ExecutionResult:
    ...
    def _execute_sketch_safely(self, sketch_path: Path, output_dir: Path) -> ExecutionResult:
    ...
    def _execute_with_subprocess(self, sketch_path: Path, output_dir: Path) -> ExecutionResult:
...
"""
        ...
        try:
            ...
            return ExecutionResult(
                success=False,
                error=f"Failed to execute sketch: {str(e)}"
            )
