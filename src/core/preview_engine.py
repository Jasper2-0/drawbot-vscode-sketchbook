...
from .image_converter import ImageConverter, ConversionResult
from .preview_cache import PreviewCache, CacheResult
...
class PreviewEngine:
    ...
    def _generate_preview_image(self, sketch_path: Path, execution_result: ExecutionResult, sketch_name: Optional[str] = None) -> PreviewResult:
        ...
        try:
            ...
            return PreviewResult(
                success=False,
                error=f"Preview image generation failed: {str(e)}"
            )
